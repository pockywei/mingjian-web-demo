      ...
      <MotionConfig reducedMotion="always">
        <div className="min-h-screen w-full bg-[#fafafa] font-sans">
          ...
          {slides.map((slide, index) => {
            ...
            return (
              <div key={index} className="print-page w-full h-screen flex flex-col items-center justify-center relative bg-[#fafafa]">
                {/* 背景 */}
                ...
                {/* 标题 */}
                {slide.title && (
                  <div className="absolute top-12 md:top-20 w-full text-center px-6 z-10 print-force-visible">
                ...
                {/* 主内容 */}
                <main className="w-full px-6 py-24 flex-1 flex items-center justify-center z-10 print-force-visible">
                  <CurrentComponent />
                </main>
              </div>
            );
